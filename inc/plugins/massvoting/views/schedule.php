...
<html lang="<?= ACTIVE_LANG ?>">
    <head>
        ...
        <link rel="stylesheet" href="<?= PLUGINS_URL."/".$idname."/assets/dist/switchery.css" ?>" />
        <script src="<?= PLUGINS_URL."/".$idname."/assets/dist/switchery.js" ?>"></script>
		...
		<link rel="stylesheet" href="<?= PLUGINS_URL."/".$idname."/assets/css/powerange.css?v=41".VERSION ?>">
        <script type="text/javascript" src="<?= PLUGINS_URL."/".$idname."/assets/js/powerange.js?v=41".VERSION ?>"></script>
