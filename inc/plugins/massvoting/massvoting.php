...
function install( $Plugin ) {
	...
	$sql .= 'CREATE TABLE `' . TABLE_PREFIX . 'hypervote_schedule` (
                ...
                `target` LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci,
				`answers_pk` TEXT NOT NULL COLLATE utf8mb4_unicode_ci,
				...
				`same_people_story_ignore` BOOLEAN NOT NULL,
				`follow_request_ignore` BOOLEAN NOT NULL,
				`following_ignore` BOOLEAN NOT NULL,
				`follower_ignore` BOOLEAN NOT NULL,
				`is_count_active` BOOLEAN NOT NULL,
	...
	$sql .= 'CREATE TABLE `' . TABLE_PREFIX . 'hypervote_stats` (
                ...
                `user_id` INT NOT NULL ,
                `account_id` INT NOT NULL ,
                `target` VARCHAR(1000) NOT NULL COLLATE utf8mb4_unicode_ci,
		...
		<div class="mt-10">
            <label>
                <input type="checkbox" 
                       class="checkbox" 
                       name="modules[]" 
                       value="massvoting-settings-u-likes-enable" 
                       <?= in_array("massvoting-settings-u-likes-enable", $package_modules) ? "checked" : "" ?>>
                <span>
                    <span class="icon unchecked">
                        <span class="mdi mdi-check"></span>
                    </span>
        ...
        <div class="mt-10">
            <label>
                <input type="checkbox" 
                       class="checkbox" 
                       name="modules[]" 
                       value="massvoting-settings-u-timeline-likes-enable" 
                       <?= in_array("massvoting-settings-u-timeline-likes-enable", $package_modules) ? "checked" : "" ?>>
                <span>
                    <span class="icon unchecked">
                        <span class="mdi mdi-check"></span>
                    </span>
                    <?= __('Enable timeline likes') ?>
                </span>
            </label>
        </div>
        ...
        <div class="mt-10">
            <label>
                <input type="checkbox" 
                       class="checkbox" 
                       name="modules[]" 
                       value="massvoting-settings-u-c-likes-enable" 
                       <?= in_array("massvoting-settings-u-c-likes-enable", $package_modules) ? "checked" : "" ?>>
                <span>
                    <span class="icon unchecked">
                        <span class="mdi mdi-check"></span>
                    </span>
        ...
        <div class="mt-10">
            <label>
                <input type="checkbox" 
                       class="checkbox" 
                       name="modules[]" 
                       value="massvoting-settings-u-fuf-enable" 
                       <?= in_array("massvoting-settings-u-fuf-enable", $package_modules) ? "checked" : "" ?>>
                <span>
                    <span class="icon unchecked">
                        <span class="mdi mdi-check"></span>
                    </span>
                    <?= __('Enable follow/unfollow') ?>
                </span>
            </label>
        </div>
		 <div class="mt-10">
            <label>
                <input type="checkbox" 
                       class="checkbox" 
                       name="modules[]" 
                       value="massvoting-settings-comment-enable" 
                       <?= in_array("massvoting-settings-comment-enable", $package_modules) ? "checked" : "" ?>>
                <span>
                    <span class="icon unchecked">
                        <span class="mdi mdi-check"></span>
                    </span>
		 ...
		 <div class="mt-10">
            <label>
                <input type="checkbox" 
                       class="checkbox" 
                       name="modules[]" 
                       value="massvoting-settings-u-telegram-disable" 
                       <?= in_array("massvoting-settings-u-telegram-disable", $package_modules) ? "checked" : "" ?>>
                <span>
                    <span class="icon unchecked">
                        <span class="mdi mdi-check"></span>
                    </span>
                    <?= __('Disable Telegram notifications') ?>
                </span>
            </label>
        </div>
	<?php
